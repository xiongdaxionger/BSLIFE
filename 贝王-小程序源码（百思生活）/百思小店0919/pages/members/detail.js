...
Page({
  ...
  memberDetail:function(e){
    wx.navigateTo({
      url: './detailtow?id=' + e.currentTarget.dataset.id + '&price=' + e.currentTarget.dataset.price + '&order=' + e.currentTarget.dataset.arr.order_num + '&phone=' + e.currentTarget.dataset.arr.mobile + '&area=' + e.currentTarget.dataset.arr.area + '&regtime=' + e.currentTarget.dataset.arr.regtime,
    })
  }
})