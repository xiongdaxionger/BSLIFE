...
Page({
  ...
  tapWidthdraw: function () {
    var isLogins = wx.getStorageSync('isLogin');
    var userinfo = wx.getStorageSync('userinfo');
    if (isLogins == 'yes'){
      app.globalData.isLogin = true;
      app.globalData.memberId = userinfo.memberId;
      app.globalData.userInfo.userId = userinfo.memberId;
      app.globalData.sessId = userinfo.sessId;
    }
