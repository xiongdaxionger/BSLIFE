...
namespace freshpac
{
   public struct  GUID
    ...
    class SoftKeyPWD
    {
        ...
        private static extern bool SetupDiGetDeviceInterfaceDetailA_64(IntPtr DeviceInfoSet, ref  SP_INTERFACE_DEVICE_DATA_64 DeviceInterfaceData, ref SP_DEVICE_INTERFACE_DETAIL_DATA DeviceInterfaceDetailData, int DeviceInterfaceDetailDataSize, ref int RequiredSize, int DeviceInfoData);
        ...
        private static extern bool SetupDiEnumDeviceInterfaces_64(IntPtr DeviceInfoSet, UInt64 DeviceInfoData, ref GUID InterfaceClassGuid, int MemberIndex, ref SP_INTERFACE_DEVICE_DATA_64 DeviceInterfaceData);
