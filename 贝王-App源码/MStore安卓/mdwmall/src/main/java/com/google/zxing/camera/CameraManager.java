...
public final class CameraManager
{
    ...
    private final int MAX_FRAME_WIDTH = 480;
    private final int MAX_FRAME_HEIGHT = 480;
    ...
    /**
     * Preview frames are delivered here, which we pass on to the register
    ...
    public Rect getFramingRect()
    {
        ...
        if (framingRect == null)
        {
            ...
            /**
             * 中间矩形宽为屏幕宽的3/4，同时当大于或小于限制值时，设置为限制值
             */
...
//            int topOffset = (screenResolution.y - height) / 2;
            ...
            //framingRect = new Rect(leftOffset, topOffset, leftOffset + width,
                    //topOffset + height);
//            framingRect = new Rect(90, 300, 630,940);
            width = (int)(screenResolution.x * 0.8);
			int left = (int) (screenResolution.x * 0.1);
			int top = (screenResolution.y - width)/2;
