...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private static final int DEFAULT_LINECOLOR = 0x99999999;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        passwordLength = ta.getInt(R.styleable.gridPasswordView_passwordsLength, DEFAULT_PASSWORDLENGTH);
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.layout_gridpasswordview, this);
        ...
        while (index < passwordLength) {
            View dividerView = inflater.inflate(R.layout.pull_down_layout_divider, null);
