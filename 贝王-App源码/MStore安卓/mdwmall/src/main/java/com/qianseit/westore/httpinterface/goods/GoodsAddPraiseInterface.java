...
public abstract class GoodsAddPraiseInterface extends BaseHttpInterfaceTask {
	String mMemberIdString;
	String mOptionsIdString;
	public GoodsAddPraiseInterface(QianseitActivityInterface activityInterface, String memberIdString, String optionsIdString) {
