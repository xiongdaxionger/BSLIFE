...
public class XPullDownListViewHeader extends LinearLayout {
	...
	public XPullDownListViewHeader(Context context) {
		super(context);
		initView(context);
	}

	public XPullDownListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		// 时间TextView
		mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.pull_down_layout_listview_header, null);
