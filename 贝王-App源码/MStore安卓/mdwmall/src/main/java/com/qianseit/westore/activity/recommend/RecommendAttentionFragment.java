...
public class RecommendAttentionFragment extends BaseGridFragment<JSONObject> {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mUserIDString != null && mUserIDString.equals(mLoginedUser.getMember().getMember_id())) {
			...
			mActionBar.setRightImageButton(R.drawable.recommend_attention_add, new OnClickListener() {

				@Override
				public void onClick(View v) {
					startActivity(AgentActivity.intentForFragment(mActivity, AgentActivity.FRAGMENT_RECOMMEND_ATTENTION_ADD));
				}
			});
		} else {
	...
	protected String requestInterfaceName() {
		// TODO Auto-generated method stub
		return "mobileapi.goods.get_attention";
	}
	...
	public void onClick(View v) {
		...
		case R.id.account_click_but:
			...
			new MemberUnAttentionInterface(RecommendAttentionFragment.this, dataJSON.optString("member_id"), mLoginedUser.getMember().getMember_id()) {
		...
		case R.id.account_attention_linear:
			dataJSON = (JSONObject) v.getTag();
			new MemberAttentionInterface(RecommendAttentionFragment.this, dataJSON.optString("member_id"), mLoginedUser.getMember().getMember_id()) {
