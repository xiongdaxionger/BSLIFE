...
public class ShoppingLableActivity extends Activity{
	...
	private ShoppingLableActivity mContext;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		sBar = (Button) this.findViewById(R.id.suress);
...
//					mContext.getResources(), R.drawable.image);
	...
	protected void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("2_1_6");
		MobclickAgent.onResume(this);
		MobclickAgent.onEvent(this , "2_1_6");
	}
	
	@Override
	protected void onPause() {
		super.onPause();
		MobclickAgent.onPageEnd("2_1_6");
...
//						Intent intent = new Intent();
						...
						Intent intent = AgentActivity.intentForFragment(ShoppingLableActivity.this, AgentActivity.FRAGMENT_SHOPP_COMMEND);
//						intent.setClass(getApplicationContext(), AecommendedLanguageActivity.class);
						...
						Toast.makeText(ShoppingLableActivity.this, "失败！", 5000).show();
					}
					break;
			}
		}
