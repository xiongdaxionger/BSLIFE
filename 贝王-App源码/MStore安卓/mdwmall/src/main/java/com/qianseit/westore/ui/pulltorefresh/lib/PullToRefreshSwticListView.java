...
import com.qianseit.westore.ui.pulltorefresh.lib.internal.EmptyViewMethodAccessor;

public class PullToRefreshSwticListView extends
	...
	public PullToRefreshSwticListView(Context context) {
		super(context);
		this.setDisableScrollingWhileRefreshing(false);
	}

	public PullToRefreshSwticListView(Context context, int mode) {
		super(context, mode);
		this.setDisableScrollingWhileRefreshing(false);
	}

	public PullToRefreshSwticListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.setDisableScrollingWhileRefreshing(false);
	}
