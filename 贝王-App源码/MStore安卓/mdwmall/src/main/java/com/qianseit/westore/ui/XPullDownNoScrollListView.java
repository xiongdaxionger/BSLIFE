...
public class XPullDownNoScrollListView extends MyListView implements OnScrollListener {
	...
	public XPullDownNoScrollListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public XPullDownNoScrollListView(Context context, AttributeSet attrs, int defStyle) {
