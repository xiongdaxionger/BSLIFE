...
public class WheelView extends View {
	/** Scrolling duration */
	private final int SCROLLING_DURATION = 400;

	/** Minimum delta for scrolling */
	private final int MIN_DELTA_FOR_SCROLLING = 1;

	/** Current value & label text color */
	private final int VALUE_TEXT_COLOR = 0xF0ff5555;

	/** Items text color */
	private final int ITEMS_TEXT_COLOR = 0xFF634355;

	/** Top and bottom shadows colors */
	private final int[] SHADOWS_COLORS = new int[] { 0xFF111111,
			0x00AAAAAA, 0x00AAAAAA };

	/** Additional items height (is added to standard text item height) */
	private int ADDITIONAL_ITEM_HEIGHT = 15;//���ÿؼ��ĸ߶�
	private final int ADDITIONAL_ITEM_HEIGHT1 = 15;//���ÿؼ��ĸ߶�

	/** Text size */
	public int TEXT_SIZE = 17;
	private final int TEXT_SIZE1 = 17;
	private int SELECT_TEXT_SIZE = TEXT_SIZE + 5;
	private final int SELECT_TEXT_SIZE1 = TEXT_SIZE1 + 5;

	/** Top and bottom items offset (to hide that) */
	private final int ITEM_OFFSET = TEXT_SIZE / 3;

	/** Additional width for items layout */
	private final int ADDITIONAL_ITEMS_SPACE = 10;
	...
	private final int DEF_VISIBLE_ITEMS = 3;//���������յ�λ��
	...
	private void initData(Context context) {
		...
		if (!isInEditMode()) {
			TEXT_SIZE = Util.sp2px(context, TEXT_SIZE1);
			SELECT_TEXT_SIZE = Util.sp2px(context, SELECT_TEXT_SIZE1);
			ADDITIONAL_ITEM_HEIGHT = Util.dip2px(context, ADDITIONAL_ITEM_HEIGHT1);
		}
	}
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(SELECT_TEXT_SIZE);
