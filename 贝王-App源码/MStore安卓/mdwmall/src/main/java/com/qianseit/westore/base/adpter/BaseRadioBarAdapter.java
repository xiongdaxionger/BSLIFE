...
public class BaseRadioBarAdapter extends BaseSelectAdapter<RadioBarBean> {
	Context mContext;
	int mVisibleCount = 5;
	int width;
	protected RadioBarCallback mBarCallback;
	private Drawable divideDrawable = null;

	public BaseRadioBarAdapter(Context context, List<RadioBarBean> dataList, RadioBarCallback callback) {
		super(dataList);
	...
	public interface RadioBarCallback {
		...
		boolean onSelectedRadioBar(RadioBarBean barBean);
	}
}
