...
public class XPullDownListView extends ListView implements OnScrollListener {
	...
	public XPullDownListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public XPullDownListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public int getHeadlerVisiableHeight(){
