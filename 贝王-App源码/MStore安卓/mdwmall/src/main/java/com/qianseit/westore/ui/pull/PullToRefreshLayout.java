...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private ProgressBar mRefeshBar;
	// 上拉头
...
//					.setBackgroundResource(R.drawable.allview_load_failed);
	...
	private void changeState(int to) {
		...
		case REFRESHING:
			// 正在刷新状态
			//pullView.clearAnimation();
			mRefeshBar.setVisibility(View.VISIBLE);
		...
		case LOADING:
			...
			loadStateTextView.setText(R.string.refreshing);
			break;
		case DONE:
			// 刷新或加载完毕，啥都不做
			mRefeshBar.setVisibility(View.INVISIBLE);
	...
	public void setPullDown(boolean isDown){
		isCanPullDown=isDown;
	}

	public void setPullUp(boolean isUp){
		isCanPullUp=isUp;
	}
	...
	private void initView() {
		...
		mRefeshBar=(ProgressBar)refreshView.findViewById(R.id.state_add_bar);
		refreshingView = refreshView.findViewById(R.id.refreshing_icon);
		refreshStateImageView = refreshView.findViewById(R.id.state_iv);
		// 初始化上拉布局
		pullUpView = loadmoreView.findViewById(R.id.pullup_icon);
		mLoadBar=(ProgressBar)loadmoreView.findViewById(R.id.state_load_add_bar);
