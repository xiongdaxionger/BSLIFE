 ...
 */
@SuppressLint("NewApi")
public class ShoppingSentimentFragment extends BaseDoFragment implements IXListViewListener,ShareViewDataSource {
	...
	public ShoppingSentimentFragment() {
	}
	...
	public class SelectsAdapter extends BaseAdapter {
		...
		public View getView(final int position, View converView, ViewGroup parent) {
			...
			textview_content.setMText(Html.fromHtml("[好物评价]</font><font size=\"4\" color=\"#9b9b9b\"></font>" + selectInfo.getTextview_content()));
