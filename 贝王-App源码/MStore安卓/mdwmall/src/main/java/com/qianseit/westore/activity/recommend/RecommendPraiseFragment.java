...
public class RecommendPraiseFragment extends BaseListFragment<JSONObject> {
	...
	protected View getItemView(JSONObject responseJson, View convertView, ViewGroup parent) {
        ...
        convertView.findViewById(R.id.item_receive_pc_praise).setVisibility(View.VISIBLE);
		...
		convertView.findViewById(R.id.item_receive_pc_username).setVisibility(View.VISIBLE);
		return convertView;
	}
