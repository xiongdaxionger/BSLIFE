...
public class XPullDownSwipeMenuListView extends SwipeMenuListView implements OnScrollListener {
	...
	public XPullDownSwipeMenuListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public XPullDownSwipeMenuListView(Context context, AttributeSet attrs, int defStyle) {
