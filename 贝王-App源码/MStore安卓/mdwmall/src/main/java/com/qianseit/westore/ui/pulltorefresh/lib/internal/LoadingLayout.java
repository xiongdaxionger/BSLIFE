package com.qianseit.westore.ui.pulltorefresh.lib.internal;
...
public class LoadingLayout extends FrameLayout {
	...
	final int DEFAULT_ROTATION_ANIMATION_DURATION = 150;
	...
	public LoadingLayout(Context context, final int mode, String releaseLabel,
		...
		resetRotateAnimation.setAnimationListener(new AnimationListener() {
