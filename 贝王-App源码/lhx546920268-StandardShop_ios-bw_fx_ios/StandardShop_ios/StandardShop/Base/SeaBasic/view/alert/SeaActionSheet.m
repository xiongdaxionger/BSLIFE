...
- (void)initlization
{
    ...
    //tableView高度
    CGFloat tableViewHeight = MIN(_otherButtonTitles.count * SeaActionSheetButtonHeight + titleHeight, _height_ - SeaActionSheetMargin * 3 - SeaActionSheetButtonHeight);
