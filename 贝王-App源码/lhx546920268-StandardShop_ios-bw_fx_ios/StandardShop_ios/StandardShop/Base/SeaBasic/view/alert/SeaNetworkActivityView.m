...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        self.backgroundColor = [UIColor colorFromHexadecimal:@"4C4C4C"];
...
//        label.font = [UIFont fontWithName:MainFontName size:16.0];
...
- (void)layoutSubviews
{
    ...
    frame.origin.y = self.circle.bottom + interval;
    frame.origin.x = 0;
