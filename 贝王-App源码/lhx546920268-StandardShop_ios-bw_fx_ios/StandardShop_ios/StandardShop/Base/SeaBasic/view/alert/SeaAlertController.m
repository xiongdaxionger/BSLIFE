 ...
 *  @param style             样式
 *  @param otherButtonTitles 取消按钮 default is ‘取消’
 *  @param buttonTitles      按钮，必须是字符串NSString，必须以nil结束，否则会崩溃
 *  @return 一个实例
 */
...
- (void)show
{
    ...
    {
        vc = appDelegate.window.rootViewController.presentedViewController;
    }
    else
    {
