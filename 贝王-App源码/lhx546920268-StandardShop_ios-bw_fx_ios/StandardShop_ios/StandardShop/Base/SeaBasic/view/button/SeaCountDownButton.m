...
- (void)initialization
{
    ...
    self.disableTitle = @"";
    self.countdownTimeInterval = 120;
    self.layer.cornerRadius = 3.0;
    self.layer.masksToBounds = YES;
    self.normalBackgroundColor = WMButtonBackgroundColor;
    self.disableBackgroundColor = [UIColor colorWithWhite:0.90 alpha:1.0];
    [self setTitleColor:WMButtonTitleColor forState:UIControlStateNormal];
...
- (void)countDown:(id) sender
{
    ...
    [self setTitle:[NSString stringWithFormat:@"%@%ds", self.disableTitle, self.curTimeInterval] forState:UIControlStateDisabled];
}
