...
- (void)updatePlaceHolder
{
    ...
    CGSize size = [self.placeholder stringSizeWithFont:self.placeholderFont contraintWith:_width_ - self.placeholderOffset.x * 2];
    self.placeHolderLabel.frame = CGRectMake(self.placeholderOffset.x, self.placeholderOffset.y, size.width, size.height);
}
