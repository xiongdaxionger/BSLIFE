...
//        return;
    ...
    if(visibles.count > 2)
    {
        ...
        {
            [self.collectionView scrollToItemAtIndexPath:[visibles lastObject] atScrollPosition:UICollectionViewScrollPositionCenteredHorizontally animated:flag];
        }
        else
        {
