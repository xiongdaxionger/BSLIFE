...
@interface WMGoodsStoreViewController ()<SeaHttpRequestDelegate>
...
@implementation WMGoodsStoreViewController
...
{
    long long count = 0;
    NSArray *array = [WMGoodListOperation goodsStoreFromData:data totalSize:&count];
...
- (void)loadInfo
{
    [self.http downloadWithURL:SeaNetworkRequestURL dic:[WMGoodListOperation goodsStoreParamsWithPage:self.curPage]];
}
