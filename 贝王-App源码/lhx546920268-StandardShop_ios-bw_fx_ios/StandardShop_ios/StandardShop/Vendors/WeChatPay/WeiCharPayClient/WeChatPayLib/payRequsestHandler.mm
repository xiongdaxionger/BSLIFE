...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPayWithModel:(WeChatPayViewModel *)viewModel
{

    //订单标题，展示给用户
//    NSString *order_name    = viewModel.weChatPayBody;
//    
//    //订单金额,单位（分）
//    NSString *order_price   = viewModel.weChatPayTotalAmount;
...
//    [packageParams setObject: viewModel.weChatPayNonceStr          forKey:@"nonce_str"];   //随机串
//    [packageParams setObject: @"APP"            forKey:@"trade_type"];  //支付类型，固定为APP
//    [packageParams setObject: order_name        forKey:@"body"];        //订单描述，展示给用户
//    [packageParams setObject: viewModel.weChatPayCallBackURL        forKey:@"notify_url"];  //支付结果异步通知
//    
//    [packageParams setObject: viewModel.weChatPaymentId           forKey:@"out_trade_no"];//商户订单号
//    [packageParams setObject: viewModel.weChatPayIP    forKey:@"spbill_create_ip"];//发器支付的机器ip
